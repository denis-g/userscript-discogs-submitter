...
(function () {
    ...
    (function () {
        ...
        const RELEASE_TYPES = Object.keys(TITLE_FORMAT);
        const FILE_FORMATS = [
            "WAV",
            "FLAC",
            "MP3",
        ...
        class UiSelect {
            ...
            bindEvents() {
                ...
                document.addEventListener("click", (event) => {
                    if (this.ui.container && !this.ui.container.contains(event.target)) {
                        this.closeDropdown();
                    }
                });
            }
        ...
        const DiscogsMapper = {
            mapToPayload: (data, sourceUrl, options) => {
...
${error.stack || error}`;
        ...
        const iconChevronDown = "<svg viewBox=\"0 0 640 640\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"m297.4 470.6c12.5 12.5 32.8 12.5 45.3 0l192-192c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-169.4 169.4-169.4-169.3c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l192 192z\"/></svg>";
        ...
        const iconSquareCheck = "<svg viewBox=\"0 0 640 640\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"m480 96c35.3 0 64 28.7 64 64v320c0 35.3-28.7 64-64 64h-320c-35.3 0-64-28.7-64-64v-320c0-35.3 28.7-64 64-64zm-42 113.7c-10.7-7.8-25.7-5.4-33.5 5.3l-119.4 164.2-52.1-52.1c-9.4-9.4-24.6-9.4-33.9 0s-9.4 24.6 0 33.9l72 72c5 5 11.9 7.5 18.8 7s13.4-4.1 17.5-9.8l135.9-187c7.8-10.7 5.4-25.7-5.3-33.5z\"/></svg>";
